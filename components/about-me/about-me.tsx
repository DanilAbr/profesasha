    ...
    <section className="about-me">
      <div className="about-me__content">
        ...
        <p className="about-me__text">
          ...
          устным переводчиком на крупном предприятии. Сдала экзамен DELE уровней C1&nbsp;и&nbsp;С2. Получила
          аккредитацию
          ...
          <br />
          Провожу индивидуальные занятия с учениками дистанционно. Подробную информацию о&nbsp;занятиях можно узнать
          далее:
        </p>
      </div>
    </section>
