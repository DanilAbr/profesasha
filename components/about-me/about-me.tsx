    ...
    <section className="about-me">
      <div className="about-me__content">
        ...
        <p className="about-me__text">
          ...
          квалификацию, обучаясь самостоятельно и&nbsp;на&nbsp;специализированных курсах для преподавателей. Провожу
          индивидуальные занятия с учениками дистанционно. Подробную информацию о&nbsp;занятиях можно узнать далее:
        </p>
      </div>
    </section>
  )
